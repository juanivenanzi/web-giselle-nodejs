    ...
    >
      <div className="max-w-300 mx-auto">
        ...
        <form
          ...
          className="reveal reveal-delay-1 flex flex-col gap-4 relative max-w-2xl mx-auto"
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="form-group flex flex-col gap-1.5">
              <input
                ...
                maxLength={100}
                placeholder=" "
                className="py-3.5 px-4 rounded-xl bg-(--color-fondo) border-2 border-(--color-texto-sec) text-sm text-(--color-texto) t-modo focus:outline-none focus:border-(--color-texto)"
              />
          ...
          <div className="form-group flex flex-col gap-1.5">
            <textarea
              ...
              placeholder=" "
              rows={4}
              className="py-3.5 px-4 rounded-xl bg-(--color-fondo) border-2 border-(--color-texto-sec) text-sm text-(--color-texto) t-modo focus:outline-none focus:border-(--color-texto) resize-y min-h-25"
            ></textarea>
            <label htmlFor="volMensaje">
